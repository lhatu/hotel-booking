        ...
        <div className='py-28 md:py-35 px-4 md:px-16 lg:px-24 xl:px-32'>
            ...
            <div className='flex flex-col md:flex-row md:justify-between mt-10'>
                <div className='flex flex-col'>
                    <h1 className='text-3xl md:text-4xl font-playfair'>Experience Luxury Like Nerver Before</h1>
            ...
            shadow-[0px_0px_20px_rgba(0,0,0,0.15)] p-6 rounded-xl mx-auto mt-16 max-w-6xl' onSubmit={onSubmitHandler} >
                <div className='flex flex-col flex-wrap md:flex-row items-start md:items-center gap-4 md:gap-10 text-gray-500'>
                    <div className='flex flex-col'>
                        ...
                        px-3 py-2 mt-1.5 outline-none' required onChange={(e)=>setCheckInDate(e.target.value)} min={new Date().toISOString().split('T')[0]} />
                    </div>
                    ...
                    <div className='flex flex-col'>
                        ...
                        px-3 py-2 mt-1.5 outline-none' required onChange={(e)=>setCheckOutDate(e.target.value)} min={checkInDate} disabled={!checkInDate} />
                    </div>
                    <div className='w-px h-15 bg-gray-300/70 max-md:hidden'></div>
                    <div className='flex flex-col'>
                        <label htmlFor="guests" className='font-medium'>Guests</label>
                        <input type="number" id='guests' placeholder='1' className='max-w-20 rounded border border-gray-300 px-3 py-2
                        mt-1.5 outline-none' required onChange={(e)=>setGuests(e.target.value)} value={guests} />
                    </div>
                </div>
            ...
            <div className='max-w-3xl border-y border-gray-300 my-15 py-10 text-gray-500'>
                <p>
                    Guest will be allocated on the ground floor accourding to the availability. You get a comfortable
                    Two Bedroom Apartment has a true city feeling. The price quoted is for two guests, at the guests slot
                    please mark the number of guests to get the exact price for the group. The Guests will be allocated
                    ground floor rooms, if you want to book the first floor rooms please contact us on the number provided
