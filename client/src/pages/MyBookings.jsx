...
const MyBookings = () => {
    ...
    return (
        <div className='py-28 md:py-35 md:pt-32 px-4 md:px-16 lg:px-24 xl:px-32'>
            <Title title='My Booking' subTitle='Easy manage your past, current, and upcoming
            ...
            <div className='max-w-6xl mt-8 w-full text-gray-800'>
                ...
                {bookings.map((booking) => (
                    <div key={booking.id} className='grid grid-cols-1 md:grid-cols-[3fr_2fr_1fr] 
                    w-full border-b border-gray-300 py-6 first:border-t'>
                        ...
                        <div className='flex flex-col items-start justify-center pt-3'>
                            <div className='flex items-center gap-2'>
                                ...
                                : "text-red-500"}`}>{booking.isPaid ? "Paid" : "Unpaid"}</p>
                            </div>
                            {!booking.isPaid && (
