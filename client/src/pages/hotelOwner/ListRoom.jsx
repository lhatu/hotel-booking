...
const ListRoom = () => {
    ...
    const toggleAvailability = async (roomId) => {
        try {
            ...
            if (data.success) {
                ...
                fetchRooms(); // Refresh the room list after toggling availability
            } else {
                toast.error(data.message);
            }
        } catch (error) {
    ...
    return (
        <div>
            <Title align='left' font='outfit' title='Room Listings' subTitle='View, eidt, 
            or manage all listed rooms. Keep the information up-to-date to provide the best
