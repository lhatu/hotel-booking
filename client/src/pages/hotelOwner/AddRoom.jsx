...
const AddRoom = () => {
    ...
    return (
        <form>
            ...
            details carefully and accurate details, pricing, and amenities, to enhance
            ...
            <div className='grid grid-cols-2 sm:flex gap-4 my-2 flex-wrap'>
                {Object.keys(images).map((key) => (
                    <label htmlFor={`roomImage${key}`} key={key}>
                        ...
                        alt="img-upload" className='max-h13 cursor-pointer opacity-80' />
            ...
            <div className='w-full flex max-sm:flex-col sm:gap-4 mt-4'>
                <div className='flex-1 max-w-48'>
                    ...
                    onChange={e => setInputs({...inputs, roomType: e.target.value})} value={inputs.roomType}>
